...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.adminUpdateButton.clicked.connect(self.adminUpdateProducts)
        ...
        self.updateLabel_3.setText(u"Product 3")
        self.accountButton = QPushButton(MainWindow)
        ...
        self.updateLabel.setText(u"Product 1")
        self.updateLabel_4 = QLabel(MainWindow)
        self.updateLabel_4.setObjectName(u"updateLabel_4")
        self.updateLabel_4.setGeometry(QRect(630, 350, 61, 16))
        self.updateLabel_4.setText(u"Product 4")
        self.updateProduct_1 = QPushButton(MainWindow)
        self.updateProduct_1.setObjectName(u"updateProduct_1")
        self.updateProduct_1.setGeometry(QRect(120, 230, 110, 110))
        self.updateProduct_2 = QPushButton(MainWindow)
        self.updateProduct_2.setObjectName(u"updateProduct_2")
        self.updateProduct_2.setGeometry(QRect(280, 230, 110, 110))
        self.updateProduct_3 = QPushButton(MainWindow)
        self.updateProduct_3.setObjectName(u"updateProduct_3")
        self.updateProduct_3.setGeometry(QRect(440, 230, 110, 110))
        self.updateProduct_4 = QPushButton(MainWindow)
        self.updateProduct_4.setObjectName(u"updateProduct_4")
        self.updateProduct_4.setGeometry(QRect(600, 230, 110, 110))
        self.updateLabel_2 = QLabel(MainWindow)
        self.updateLabel_2.setObjectName(u"updateLabel_2")
        self.updateLabel_2.setGeometry(QRect(310, 350, 49, 16))
        self.updateLabel_2.setText(u"Product 2")
        self.titleLabel_1 = QLabel(MainWindow)
        self.titleLabel_1.setObjectName(u"titleLabel_1")
        self.titleLabel_1.setGeometry(QRect(290, 170, 251, 31))
        self.titleLabel_1.setText(u"Update product details")
        self.titleLabel_1.setStyleSheet(u"font-size: 24px;\n" "color: rgb(31, 115, 82);")
        ...
        self.updateProduct_1.hide()
        self.updateProduct_2.hide()
