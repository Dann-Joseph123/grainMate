...
################################################################################
## Form generated from reading UI file 'thesisUIformUnpaidOrPaidZvSAtM.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.textEdit.setGeometry(QRect(480, 80, 181, 61))
        font2 = QFont()
        ...
        self.orderConfirmation.setGeometry(QRect(160, 250, 381, 41))
        font3 = QFont()
...
"color: rgb(241, 251, 249);")
        ...
        self.instructionLabel.setGeometry(QRect(250, 220, 221, 16))
        self.instructionLabel.setFont(font3)
        self.orderCancellation = QPushButton(self.groupBox)
        self.orderCancellation.setObjectName(u"orderCancellation")
        self.orderCancellation.setGeometry(QRect(160, 300, 381, 41))
        self.orderCancellation.setFont(font3)
        self.orderCancellation.setMouseTracking(True)
        self.orderCancellation.setTabletTracking(True)
        self.orderCancellation.setStyleSheet(u"background-color: rgb(200, 0, 0);\n"
"color: rgb(240, 240, 240);")
        self.orderCancellation.setCheckable(True)
        self.orderCancellation.setFlat(False)
    ...
    def retranslateUi(self, Form):
        ...
        self.orderCancellation.setText(QCoreApplication.translate("Form", u"Cancel", None))
    # retranslateUi
